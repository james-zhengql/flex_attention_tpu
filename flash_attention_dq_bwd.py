...
def run_bench_suite(q, k, v, l, m, o, do, d, *, sm_scale, block_b, block_q, block_k_major, block_k, causal=False, score_fn=None):
...
def main():
    ...
    # Note: masks.make_causal_mask_fns usually assumes specific blocking. 
    # If it depends on block_q_major, ensure it is compatible with the new block_q only grid.
    ...
    dq_ref, dk_ref, dv_ref = mha_bwd_reference(q, k, v, o, do, l, m, sm_scale=sm_scale,causal=causal)
    ...
    bwd_dq = flash_attention_bwd_dq(
        ...
        block_b=block_b,
        block_q=block_q,
        # Removed block_q_major argument
